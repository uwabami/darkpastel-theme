...
(defun color-theme-darkpastel ()
  ...
  (color-theme-install
   `(color-theme-darkpastel
     ...
     ;; (anything-bmkext-gnus ((t (:foreground ,pastel-magenta))))
     ;; (anything-bmkext-info ((t (:foreground "green"))))
     ;; (anything-bmkext-man ((t (:foreground "Orange4"))))
     ;; (anything-bmkext-no--file ((t (:foreground "gray"))))
     ;; (anything-bmkext-w3m ((t (:foreground ,pastel-yellow))))
     ;; (anything-bookmarks-su-face ((t (:foreground ,pastel-red))))
     ;; (anything-dir-heading ((t (:background ,pastel-pink :foreground ,pastel-blue))))
     ...
     ;; (anything-ffiles-prefix-face ((t (:background ,pastel-yellow :foreground "black"))))
     ;; (anything-file-name ((t (:foreground ,pastel-blue))))
     ;; (anything-gentoo-match-face ((t (:foreground ,pastel-red))))
     ;; (anything-header ((t (:underline t :inverse-video nil :background "gray75" :foreground "black" :box (:line-width -1 :style released-button)))))
     ;; (anything-isearch-match ((t (:background ,pastel-yellow))))
